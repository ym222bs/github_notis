...
const Settings = ({ org, settingsArray }) => {
  if (!_.isEmpty(settingsArray)) {
    return <SettingsComponent organization={org} settingsList={settingsArray} />
  } else {
    return (
      <div
      ...
      >
        There is no webhook set on this organization yet. Once you have created
        a webhook then you will be able to manage your setting for that webhook
        here.
      </div>
    )
  }
