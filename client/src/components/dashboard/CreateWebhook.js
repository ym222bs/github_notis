...
const CreateWebhook = ({ hookUrl, org }) => {
    ...
    return (
        <>
            {success !== '' && <SuccessAlert validation={success} />}
            <div
                className='container'
                style={{
            ...
            >
                Create your webhook on this Organization and receive events to
                your Slack.
                <br />
                ...
                <div style={{ marginTop: '5rem' }}>
                    If you are unsure on how to create a Slack webhook key,
                    check out the docs
                    <a
                        target='_blank'
